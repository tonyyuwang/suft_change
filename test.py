...
# os.environ["CUDA_VISIBLE_DEVICES"] = "0,1,2,3"  # on
# os.environ["CUDA_VISIBLE_DEVICES"] = "0"  # off
...
@click.option('--add_l1_loss', type=bool, default=False)            # add after classification.
...
def main(
    ...
    print("test with_regression", with_regression)
