...
class COCODataset(Dataset):
    def __init__(
        ...
        super().__init__()
        self.dataset_dir = dataset_dir  # '/home/f403/999G/wy/ImageNet'
        self.image_dir = os.path.join(self.dataset_dir, split)       # for imagenet '/home/f403/999G/wy/ImageNet/train'
        ...
        if self.add_mask:
            ...
            print(os.path.join(self.dataset_dir), 'mask_prior.pickle')  # 修改后
    ...
    def get_img(self, key):
        ...
        if self.add_mask:
            ...
            for l_range in range(self.mask_num):  # 4
